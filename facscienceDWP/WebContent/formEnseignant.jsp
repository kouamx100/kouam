...
<title>formulaire des enseignant</title>
...
<div id="page-heading"><h1>ajouter un enseignant
<font color="green"> <% 
if("ok".equals(etat)){
...
<tr>
	...
	<td>
		...
		<!-- start id-form -->
	<form action="GestionEnseignant" name="formu" method="post">
		...
		<tr>
			<th valign="top" name="MotDePass2" required>Retaper le Mot De Passe:</th>
			<td><input type="password" class="inp-form" name="motDePass2"/></td>
			<td></td>
		</tr>
			<tr>
			<th valign="top" name="libelefil">Libele de la filiere:</th>
			<td>
			     <select id="d" class="inp-formeu" name="libelefil">
			       
			       <option value="math"> maths</option>
			       <option value="informatique"> informatique</option>
			       <option value="biochimie"> biohimie</option>     
			     </select>
			</td>
			<td></td>
		</tr>
