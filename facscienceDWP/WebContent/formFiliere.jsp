...
<title>formulaire de filiere</title>
...
<div id="page-heading"><h1>ajouter une filiere<font color="green"> <% 
if("ok".equals(etat)){
...
<tr>
	...
	<td>
		...
		<!-- start id-form -->
		<form action="GestionFilieres" name="formu" method="post">
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
		<tr>
			<th valign="top" >Libele:</th>
			<td><input type="text" class="inp-form" required autofocus name="libele"/></td>
			<td>
		...
		<tr>
			<th valign="top">Departement:</th>
			<td><input type="text" class="inp-form-error" name="departement" required/></td>
