...
<title>formulaire des matieres</title>
...
<div id="page-heading"><h1>ajouter une matiere
<font color="green"> <% 
if("ok".equals(etat)){
...
<tr>
	...
	<td>
		...
		<!-- start id-form -->
	<form action="GestionMatiere" name="formu" method="post">
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
		<tr>
			<th valign="top" name="code">code</th>
			<td><input type="text" class="inp-form" name="code"/></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top" name="intitule">intitule</th>
			<td><input type="text" class="inp-form-error" name="intitule"/></td>
			<td>
		...
		<tr>
			<th valign="top" name="nombre">nombre de credits</th>
			<td><input type="text" class="inp-form" name="nombre"/></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top" name="matricule">matricule de l'enseignant</th>
			<td><input type="text" class="inp-form" name="matricule"/></td>
			<td></td>
		</tr>
	...
	<tr>
		<th>&nbsp;</th>
		<td valign="top">
			<input type="submit" value="formu" class="form-submit" name="formu"/>
		...
		<div id="related-act-bottom">
			...
			<div id="related-act-inner">
				...
				<div class="right">
					...
					les differentes fili̬res du departement
					<ul class="greyarrow">
