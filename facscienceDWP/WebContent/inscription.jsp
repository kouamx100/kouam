...
<div id="content">
	...
	<%if(etudiants!=null)
		%>
		<h1>saisie des notes de **<%=matiere.getIntitule() %>**</h1>
	</div>
	<!-- end page-heading -->
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					<td class="green-left">veuiller sair les notes <a href=""> dans la rubique note</a></td>
			...
			for(Iterator<Etudiant> i = etudiants.iterator(); i.hasNext();){
				j+=1;
				Etudiant etudiant = (Etudiant) i.next();
		    ...
		    %>
				<tr <%if(j%2==0){
					...
					<td><a href=""><%=etudiant.getMatricule() %></a></td>
