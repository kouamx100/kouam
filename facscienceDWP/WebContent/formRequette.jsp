...
<title>Saisie de la requette</title>
...
<div id="page-heading"><h1>ajouter une filiere
<font color="green"> <% 
if("ok".equals(etat)){
...
<tr>
	...
	<td>
		...
		<!-- start id-form -->
		<form action="GestionRequettes" name="formu" method="post">
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
		
		<tr>
			<th valign="top" >Objet:</th>
			<td><input type="text" class="inp-form" required autofocus name="objet"/></td>
			<td>
		...
		<tr>
			<th valign="top">matricule:</th>
			<td><input type="text" class="inp-form-error" name="matricule" required/></td>
		...
		<tr>
			<th valign="top">code de la matiere:</th>
			<td><input type="text" class="inp-form-error" name="code" required/></td>
